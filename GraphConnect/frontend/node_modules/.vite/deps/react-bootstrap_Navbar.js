...
var Context = (0, import_react15.createContext)(canUseDOM_default2 ? window : void 0);
...
var resolveContainerRef = (ref, document2) => {
  if (!canUseDOM_default2) return null;
  if (ref == null) return (document2 || ownerDocument2()).body;
