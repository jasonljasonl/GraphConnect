...
from .views import PostsListViewAPI, PostCreateView, PostUpdateView, PostLikeView, CommentCreateView, \
    ViewPostView, CommentsListView, CommentDeleteView, CommentUpdateView, CommentLikeView, \
    delete_post_api

urlpatterns = [
    path('', PostsListViewAPI.as_view(), name='post_list'),
